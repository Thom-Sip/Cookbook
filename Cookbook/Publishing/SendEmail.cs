...
namespace Cookbook.Publishing
{
    public class SendEmail
    {
        ...
        public void SendPublishCompletionEmail(string name, string email, string itemPath, string languages, bool deep, bool publishRelatedItems, DateTime publishDate)
        {
